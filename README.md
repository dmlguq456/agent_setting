...
| **🔬 연구·실험** (ML 실험·연구 코드) | `analyze-project`/`autopilot-research` → `autopilot-spec` (옵션, ref repo fetch + Phase 1.5 ckpt 검증) → `autopilot-lab` (실험 반복) | 자료 → 청사진·skeleton → 실험 prototype (반복) |
