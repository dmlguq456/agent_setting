...
| [`loops/README.md`](loops/README.md) | **상시 루프** (세션 밖 cron·headless) — **당직**(`duty`, 시간형 05:37 작업장 순찰·보고) · **일지**(`note`, 시간형 05:03 산출물 → worklog-board 노트화) · **모의훈련**(`golden/`, 사건형 — 지침 수정 후 행동 회귀 시험) · 후보 backlog. 출구는 모두 보고·제안까지 (merge 만 Claude 선별 책임 — CONVENTIONS §5.10) |
...
│   ├── duty.md·.sh        당직 — 매일 05:37 순찰 6항목, 보고서 notes/duty/ (파일 자체가 heartbeat)
