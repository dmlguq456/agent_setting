...
check_codex_utility_projection() {
  ...
  UTILITY_DEFERRED="artifact-root.test.sh dispatch-artifact-root.test.py worktree-cleanup.test.py dispatch-liveness.sh dispatch-liveness.test.sh dispatch-wait.sh dispatch-wait.test.sh dispatch-concurrency.test.sh usage-check.sh usage-check.test.sh dispatch-route.test.sh extract_web_figures.py capability-route.py capability_route.test.py dispatch-node.py dispatch-registry.py dispatch_adapters_v11.test.py dispatch_contract.py dispatch_contract.test.py nested-dispatch-eligibility.py stage-dispatch-fallback.py stage_dispatch_fallback.test.py spec-transaction.py spec_transaction.test.py worker-route-guard.py worker_route_guard.test.py model-worker-governor.py model_worker_governor.test.py resource-runner.py resource_runner.test.py"
  utility_count=0
