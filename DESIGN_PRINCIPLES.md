...
**메인 Claude 응답 자체** 의 메타 원칙은 별개 layer — CLAUDE.md §1~§6 single source (§1 판교체 회피 · §2 출력 자제 · §3 동사 약속어 self-check · §4 pause flag 비자동 · §5 질문 후 자율 진행 · §6 autopilot-* 호출 Pre-check + 컨펌 패턴).
