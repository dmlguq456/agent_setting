...
ln -sfn "$AGENT_HOME/CORE.md" "$HOME/.claude/CORE.md"
ln -sfn "$AGENT_HOME/WORKFLOW.md" "$HOME/.claude/WORKFLOW.md"
ln -sfn "$AGENT_HOME/CONVENTIONS.md" "$HOME/.claude/CONVENTIONS.md"
ln -sfn "$AGENT_HOME/OPERATIONS.md" "$HOME/.claude/OPERATIONS.md"
ln -sfn "$AGENT_HOME/MEMORY.md" "$HOME/.claude/MEMORY.md"
ln -sfn "$AGENT_HOME/DESIGN_PRINCIPLES.md" "$HOME/.claude/DESIGN_PRINCIPLES.md"
