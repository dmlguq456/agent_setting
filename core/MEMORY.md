...
- 정규화·stopword/document-frequency 억제 뒤 `2+ distinct match + coverage` 또는 rare CJK/identifier exact match 같은 고신뢰 후보만 qualified 된다. 과거지시 신호어는 explicit mode 민감도를 높이지만 generic 단어 단독 hit는 거부한다.
