...
| OpenCode native plugin surface | not yet materialized | needs-split | OpenCode has JS/TS plugin hook surfaces. Generate adapter-owned plugin hooks from core guard contracts; do not reuse Claude hook files as OpenCode-native output. |
