...
“Lab only emits; it does not push proactively” scopes to the worklog approval queue and Layer 1 card creation; mandatory Layer 2 `follow-up note cycle` registration is separate and required by `WORKFLOW.md §0.2`.
