...
| 2 | **Verifier subagent** | `Agent(디자인팀, mode=verifier)` | Independent two-layer breakage gate and vision pass rate: zero-tolerance console, layout, and token checks followed by visual-consistency assessment |
| 3 | **Design rules** | `roles/modes/design/_design_rules.md` | Prompt contract for slop avoidance, visual defaults, scale, HTML conventions, and variants |
