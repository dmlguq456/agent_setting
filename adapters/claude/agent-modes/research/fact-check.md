...
- `autopilot-draft` selected strategy/draft source-check gate — fact-checker instance when claims/citations/cards are in scope
- `autopilot-research` selected report-check gate — fact-checker when source claims are in scope
