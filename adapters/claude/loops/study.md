...
4. **내부 위생 (가볍게)**: `loops/drill/metrics.csv` 의 g0_overhead in_tok 추세 (세팅 세금 증감) + 지침 문서 간 모순·비대 후보 1~2건 + **의도 불명 지침** (왜·날짜·계기 주석 없는 규칙 — CONVENTIONS §3(항목 8) 위반) 후보 1~2건. **상한 경보**: g0 in_tok 45k 초과 시 ⚠️ 다이어트 권고 (2026-06-11 기준선 ~40k; context 파일 과다는 성능 역효과 — 매뉴얼 1부 Tension ④ 반례 데이터).
