...
5. **sync-skills drift**: `<agent-home>/skills/*/SKILL.md`·`<agent-home>/agents/*.md` 중 `<agent-home>/skills/.sync_state.json` 보다 새로운 파일 존재 → "skill 정의 변경 후 README 미동기화 — `/sync-skills` 권장" 표시.
