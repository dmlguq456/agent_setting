...
> These rules apply to autopilot-draft `--mode doc` in addition to `common.md`.
...
Camera-ready integration belongs to the natural-integration rule in `paper.md`. A rebuttal response and a paper-body revision are different genres.
