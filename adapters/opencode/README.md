...
| loop guidance | `adapters/opencode/bin/preflight.sh loop-info <oncall|note|study|drill>` reports whether a loop has an OpenCode manual contract, unsupported executable projection, or missing native implementation |
