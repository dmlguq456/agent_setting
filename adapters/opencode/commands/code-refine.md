---
description: "Run the portable code-refine capability through the OpenCode adapter. Meaning: Revise an existing plan using user notes, plan-check feedback, and verification-failure notes."
---
