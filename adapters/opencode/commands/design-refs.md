---
description: "Run the portable design-refs capability through the OpenCode adapter. Meaning: Collect external and user-provided visual references and create a brief."
---
