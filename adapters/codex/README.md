...
| capability mapping | `adapters/codex/bin/preflight.sh capability-info <capability>` reports Codex's instruction-only or tool-contract realization and the legacy compatibility reference, if one exists |
