  ...
  material)
    ...
    case "$name" in
      ...
      figure-gen)
        ...
        tool_contract_check="adapters/codex/bin/preflight.sh figure-gen --check <script.py>"
        report_tool_contract_check="adapters/codex/bin/preflight.sh figure-gen --verify-report <manifest.json> <report.md>"
