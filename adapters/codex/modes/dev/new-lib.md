...
2. Read `roles/modes/dev/new-lib.md` for the portable mode contract.
...
The following contract is projected from `roles/modes/dev/new-lib.md` with non-Codex runtime
