...
2. Read `roles/units/material/pdf-extract.md` for the portable mode contract.
...
The following contract is projected from `roles/units/material/pdf-extract.md` with non-Codex runtime
