...
2. Read `roles/units/material/web-image-search.md` for the portable mode contract.
...
The following contract is projected from `roles/units/material/web-image-search.md` with non-Codex runtime
