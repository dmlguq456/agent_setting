...
2. Read `roles/units/qa/security-review.md` for the portable mode contract.
...
The following contract is projected from `roles/units/qa/security-review.md` with non-Codex runtime
