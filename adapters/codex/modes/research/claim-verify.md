...
2. Read `roles/units/research/claim-verify.md` for the portable mode contract.
...
The following contract is projected from `roles/units/research/claim-verify.md` with non-Codex runtime
