...
2. Read `roles/units/research/plan-review.md` for the portable mode contract.
...
The following contract is projected from `roles/units/research/plan-review.md` with non-Codex runtime
