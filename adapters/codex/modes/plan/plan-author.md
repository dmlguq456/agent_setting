...
2. Read `roles/units/plan/plan-author.md` for the portable mode contract.
3. Run `adapters/codex/bin/preflight.sh mode-info plan/plan-author`.
...
- Treat `adapters/codex/modes/plan/plan-author.md` as the adapter-owned mode guide for this runtime.

## Projected Portable Mode Contract

The following contract is projected from `roles/units/plan/plan-author.md` with non-Codex runtime
