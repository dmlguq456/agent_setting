...
- Treat Codex-native skills under `adapters/codex/skills/` as generated adapter output from `capabilities/`; do not load Claude Skill files as native Codex skills.
- Treat future Codex plugins or command-like surfaces as generated adapter output from `capabilities/` and `roles/`.
