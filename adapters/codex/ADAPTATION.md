...
model, then emits one blocking continuation for typed harvest. With no such
child it detaches `session-end` into the background and exits 0 with silent
