...
script="${1:-}"
case "$script" in
  sessionstart-lifecycle.py|sessionend-lifecycle.py|stop-lifecycle.py|userprompt-lifecycle.py|permissionrequest-lifecycle.py|pretooluse-write-guard.py|posttooluse-design-check.py|posttooluse-read-marker.py)
    ;;
  *)
