...
| Adapter | Realization |
|---|---|
| Claude Code | `adapters/claude/skills/design-tokens` currently projects compatibility source `skills/design-tokens/SKILL.md`. |
...
The historical Claude Skill source remains at `skills/design-tokens/SKILL.md` while this capability is being split into portable and adapter-native layers.
