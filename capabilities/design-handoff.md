...
| Adapter | Realization |
|---|---|
| Claude Code | `adapters/claude/skills/design-handoff` currently projects compatibility source `skills/design-handoff/SKILL.md`. |
...
The historical Claude Skill source remains at `skills/design-handoff/SKILL.md` while this capability is being split into portable and adapter-native layers.
