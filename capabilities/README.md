...
| `post-it` | ops | - | [`post-it.md`](post-it.md) | 프로젝트·cross-project 기록과 handoff를 working memory로 남긴다. | `adapters/claude/skills/post-it/SKILL.md` | `adapters/codex/skills/post-it/SKILL.md`; `adapters/codex/plugins/agent-harness-codex/skills/post-it/SKILL.md` | `adapters/opencode/skills/post-it/SKILL.md`; `adapters/opencode/commands/post-it.md` |
| `sync-skills` | ops | - | [`sync-skills.md`](sync-skills.md) | 정의 변경을 읽어 README/manifest/cross-doc invariant drift를 점검·동기화한다. | `adapters/claude/skills/sync-skills/SKILL.md` | `adapters/codex/skills/sync-skills/SKILL.md`; `adapters/codex/plugins/agent-harness-codex/skills/sync-skills/SKILL.md` | `adapters/opencode/skills/sync-skills/SKILL.md`; `adapters/opencode/commands/sync-skills.md` |
