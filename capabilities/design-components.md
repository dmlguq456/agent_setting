...
| Adapter | Realization |
|---|---|
| Claude Code | `adapters/claude/skills/design-components` currently projects compatibility source `skills/design-components/SKILL.md`. |
| Codex | Read this spec and run `adapters/codex/bin/preflight.sh capability-info design-components`. Do not consume `skills/design-components/SKILL.md` as native Codex configuration. |

## Compatibility Reference

The historical Claude Skill source remains at `skills/design-components/SKILL.md` while this capability is being split into portable and adapter-native layers.
