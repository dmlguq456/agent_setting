...
The historical Claude Skill source remains at `skills/analyze-user/SKILL.md` while this capability is being split into portable and adapter-native layers.
