...
- **완료 기준(checkable)**: 검증 로그(3절차 각 PASS/FAIL) + frontmatter 변경 diff(`disable-model-invocation: true` 추가된 스킬 목록).
...
- **SD-2**: Plan Resolution SoT = `autopilot-code/references/arguments-and-decisions.md` 단일 authority, code-execute/refine/report/test **4개**(SKILL.md+README.md) pointer. `grep -rln "keep in sync" skills/*/SKILL.md skills/*/README.md`=0 완료 기준.
