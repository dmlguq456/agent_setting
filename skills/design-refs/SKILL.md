...
> **컨텍스트 없이 시작하지 않는다 (스펙 §1.3 — slop 의 근원).** 브랜드·디자인 시스템·레퍼런스·톤이 전혀 없으면 brief 를 임의로 채우지 말고 _먼저 한 라운드 집중 질문_ (시작점/제품 컨텍스트, 어느 측면의 변형인지, 톤·분량·청중·제약). 작은 수정·후속이면 생략. 빈칸 > 잘못 채우기.
