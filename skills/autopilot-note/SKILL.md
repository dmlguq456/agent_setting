...
- 입력 source·출력 자리·`--qa <level>` 매트릭스·Examples·경계 (When NOT to use / Post-Run Checklist): `references/scope-qa-usage.md`.
...
- `references/scope-qa-usage.md`: Scope (입력 source 6갈래·출력 자리·NOT for), `--qa <level>` (default light), Examples, When NOT to use, Post-Run Checklist.
