...
> 본 README는 Notion 페이지 [📊 final-report](https://www.notion.so/34987c2bb75381a99e7bd9fb53ac04fb)의 미러. `/sync-skills`로 양방향 동기화. 권위 있는 동작 명세는 `SKILL.md`.
...
## 호출 형식
```
/final-report <plan name or path>
```
...
---
*원본: `~/.claude/skills/final-report/SKILL.md`*
